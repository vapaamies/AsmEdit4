...
begin
  ...
  case ListBox1.Items.Strings[ListBox1.ItemIndex] of
    ...
    'DIR_COPY'     : begin
      Memo1.Lines.Add('Копирование каталога в проект с заранее заданным положением');
      Memo1.Lines.Add('');
      Memo1.Lines.Add('Параметры:');
      Memo1.Lines.Add('');
      Memo1.Lines.Add('file1    - [Строка] Относительный путь копируемого каталога (от папки приложения, как правило начиная с папки /inf)');
      Memo1.Lines.Add('');
      Memo1.Lines.Add('file2    - [Строка] Относительный путь конечного каталога (от папки/src проекта)');
      ResultList.Clear;
      ResultList.Add(Edit1.Text);
      ResultList.Add('['+Edit1.Text+']');
      ResultList.Add('oper=DIR_COPY');
      ResultList.Add('file1=относительный путь к каталогу источнику');
      ResultList.Add('file2=относительный путь к каталогу получателю');
    end;
